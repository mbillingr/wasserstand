...
class HighLevelPredictor:
    def __init__(self, model: TimeSeriesPredictor, err=500**2, err_learning_rate=1e-3):
        self.model = model
        self.err = err
    ...
    def fit_incremental(self, epochs):
        ...
        assert self.model.meta_info["stations"] == epochs.station.to_dict()["data"]
        f = self.model.meta_info["fitted"]
    ...
    def evaluate(self, time_series):
        y_hat, y = self.model.evaluate(time_series.data)
